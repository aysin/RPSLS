...
def rpsls(player_choice): 
    ...
    if comp_number == 0 and player_number == 0:
        ...
        print "Player wins!"
    elif comp_number == 0 and player_number == 3:
        print "Computer wins!"
    ...
    if comp_number == 1 and player_number == 0:
        print "Computer wins!"
    elif comp_number == 1 and player_number == 1:
        print "Player and Computer ties!"
    ...
    if comp_number == 2 and player_number == 0:
        ...
        print "Computer wins!"
    elif comp_number == 2 and player_number == 2:
        print "Player and Computer ties!"
    ...
    if comp_number == 3 and player_number == 0:
        ...
        print "Computer wins!"
    elif comp_number == 3 and player_number == 3:
        print "Player and Computer ties!"
    ...
    if comp_number == 4 and player_number == 0:
        ...
        print "Computer wins!"
    elif comp_number == 4 and player_number == 4:
        print "Player and Computer ties!"
